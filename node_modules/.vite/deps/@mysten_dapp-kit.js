...
// node_modules/.pnpm/@mysten+dapp-kit@0.14.33_@tanstack+react-query@5.66.8_react@18.3.1__@types+react-dom@18.3.5_@_2pf5qoziu6ynvf4e6p5lxm5phi/node_modules/@mysten/dapp-kit/dist/esm/index.js
var import_react2 = __toESM(require_react());
var import_react3 = __toESM(require_react());

// node_modules/.pnpm/zustand@4.5.6_@types+react@18.3.18_react@18.3.1/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/.pnpm/zustand@4.5.6_@types+react@18.3.18_react@18.3.1/node_modules/zustand/esm/index.mjs
...
// node_modules/.pnpm/@mysten+wallet-standard@0.13.12_typescript@5.7.3/node_modules/@mysten/wallet-standard/dist/esm/wallet.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.13.12_typescript@5.7.3/node_modules/@mysten/wallet-standard/dist/esm/detect.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.13.12_typescript@5.7.3/node_modules/@mysten/wallet-standard/dist/esm/chains.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/intent.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/publickey.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/signature-scheme.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/graphql/client.js
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
// node_modules/.pnpm/@0no-co+graphql.web@1.1.1_graphql@16.10.0/node_modules/@0no-co/graphql.web/dist/graphql.web.mjs
var e = {
  NAME: "Name",
  DOCUMENT: "Document",
...
// node_modules/.pnpm/gql.tada@1.8.10_graphql@16.10.0_typescript@5.7.3/node_modules/gql.tada/dist/gql-tada.mjs
var a2 = 0;
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/graphql/schemas/2024.4/index.js
var graphql2 = initGraphQLTada();

// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/jwt-utils.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/bcs.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/signature.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/utils.js
function toPaddedBigEndianBytes(num, width) {
  const hex2 = num.toString(16);
  return hexToBytes(hex2.padStart(width * 2, "0").slice(-width * 2));
}

// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/publickey.js
...
var _ZkLoginPublicIdentifier = class _ZkLoginPublicIdentifier2 extends PublicKey {
  ...
  constructor(value2, { client } = {}) {
    ...
    if (typeof value2 === "string") {
      __privateSet3(this, _data, fromBase64(value2));
    } else if (value2 instanceof Uint8Array) {
      __privateSet3(this, _data, value2);
    } else {
      __privateSet3(this, _data, Uint8Array.from(value2));
    }
  }
  /**
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/signature.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/mnemonics.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/keypair.js
...
function decodeSuiPrivateKey(value2) {
  const { prefix, words } = import_bech32.bech32.decode(value2);
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/keypairs/ed25519/keypair.js
var import_tweetnacl3 = __toESM(require_nacl_fast(), 1);

// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/keypairs/ed25519/ed25519-hd-key.js
...
// node_modules/.pnpm/@mysten+sui@1.14.3_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/keypairs/ed25519/publickey.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/links/zk-bag.js
var _package;
var _module;
_package = /* @__PURE__ */ new WeakMap();
_module = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/links/builder.js
...
objectsToTransfer_fn = async function(tx) {
  ...
  const refsWithType = this.objectRefs.concat(
    (objectIDs.length > 0 ? await __privateGet4(this, _client2).multiGetObjects({
      ids: objectIDs,
      options: {
        showType: true
      }
...
estimateClaimGasFee_fn = async function() {
  ...
  const result = await __privateGet4(this, _client2).dryRunTransactionBlock({
    transactionBlock: await tx.build({ client: __privateGet4(this, _client2) })
  });
...
getCoinsByType_fn = async function(coinType) {
  ...
  const coins = await __privateGet4(this, _client2).getCoins({
    coinType,
    owner: this.sender
  });
...
// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/links/utils.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/links/claim.js
...
loadBagObject_fn = async function() {
  ...
  const bagField = await __privateGet5(this, _client3).getDynamicFieldObject({
...
loadBag_fn = async function({
  ...
  const objectsResponse = await __privateGet5(this, _client3).multiGetObjects({
    ids: itemIds,
    options: {
      showType: true,
      showContent: true
...
loadClaimedAssets_fn = async function() {
  var _a3;
  const result = await __privateGet5(this, _client3).queryTransactionBlocks({
    limit: 1,
    filter: {
    ...
    body: JSON.stringify({
      ...
      transactionBlockKindBytes: toBase64(
        await tx.build({
          ...
          client: __privateGet5(this, _client3)
        })
      )
    })
  });
...
listNonContractClaimableAssets_fn = async function() {
  ...
  const dryRun = await __privateGet5(this, _client3).dryRunTransactionBlock({
    transactionBlock: await tx.build({ client: __privateGet5(this, _client3) })
  });
...
createNonContractClaimTransaction_fn = function(address) {
  ...
  const objectsToTransfer = __privateGet5(this, _ownedObjects).filter((object2) => {
    if (__privateGet5(this, _gasCoin)) {
      if (object2.objectId === __privateGet5(this, _gasCoin).coinObjectId) {
        return false;
      }
...
loadOwnedObjects_fn = async function({
  ...
  let nextCursor;
  do {
    const ownedObjects = await __privateGet5(this, _client3).getOwnedObjects({
      cursor: nextCursor,
      owner: this.address,
      options: {
        showType: true,
  ...
  const coins = await __privateGet5(this, _client3).getCoins({
...
// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/links/list-created-links.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/utils/withResolvers.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/wallet/channel/events.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/wallet/channel/index.js
...
var __privateAdd4 = (obj, member, value2) => member.has(obj) ? __typeError5("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value2);
...
var StashedPopup = class {
  constructor({
    ...
    __privateAdd4(this, _StashedPopup_instances);
    __privateAdd4(this, _popup);
    __privateAdd4(this, _id);
    __privateAdd4(this, _origin);
    __privateAdd4(this, _name);
    __privateAdd4(this, _network2);
    __privateAdd4(this, _promise);
    __privateAdd4(this, _resolve);
    __privateAdd4(this, _reject);
    __privateAdd4(this, _interval, null);
    __privateAdd4(this, _listener, (event) => {
      if (event.origin !== __privateGet6(this, _origin)) {
        return;
      }
      const { success, output } = safeParse(StashedResponse, event.data);
      if (!success || output.id !== __privateGet6(this, _id)) return;
      __privateMethod4(this, _StashedPopup_instances, cleanup_fn).call(this);
      if (output.payload.type === "reject") {
        __privateGet6(this, _reject).call(this, new Error("User rejected the request"));
      } else if (output.payload.type === "resolve") {
        __privateGet6(this, _resolve).call(this, output.payload.data);
      }
    });
    ...
    __privateSet5(this, _popup, popup);
    __privateSet5(this, _id, crypto.randomUUID());
    __privateSet5(this, _origin, origin);
    __privateSet5(this, _name, name2);
    __privateSet5(this, _network2, network);
    const { promise, resolve, reject } = withResolvers();
    __privateSet5(this, _promise, promise);
    __privateSet5(this, _resolve, resolve);
    __privateSet5(this, _reject, reject);
    __privateSet5(this, _interval, setInterval(() => {
      try {
        if (__privateGet6(this, _popup).closed) {
          __privateMethod4(this, _StashedPopup_instances, cleanup_fn).call(this);
  ...
  send({
    ...
    window.addEventListener("message", __privateGet6(this, _listener));
    __privateGet6(this, _popup).location.assign(
      `${__privateGet6(this, _origin)}/dapp/${type2}?${new URLSearchParams({
        id: __privateGet6(this, _id),
        origin: window.origin,
        network: __privateGet6(this, _network2),
        name: __privateGet6(this, _name)
      })}${data ? `#${new URLSearchParams(data)}` : ""}`
    );
    return __privateGet6(this, _promise);
  }
  close() {
    __privateMethod4(this, _StashedPopup_instances, cleanup_fn).call(this);
    __privateGet6(this, _popup).close();
  }
};
...
cleanup_fn = function() {
  if (__privateGet6(this, _interval)) {
    clearInterval(__privateGet6(this, _interval));
    __privateSet5(this, _interval, null);
  }
  window.removeEventListener("message", __privateGet6(this, _listener));
};
_request = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+zksend@0.12.1_typescript@5.7.3/node_modules/@mysten/zksend/dist/esm/wallet/index.js
...
var StashedWallet = class {
  constructor({
    ...
    __privateAdd5(this, _StashedWallet_instances);
    __privateAdd5(this, _events);
    __privateAdd5(this, _accounts);
    __privateAdd5(this, _origin2);
    __privateAdd5(this, _name2);
    __privateAdd5(this, _network3);
    __privateAdd5(this, _signTransactionBlock, async ({ transactionBlock, account }) => {
      ...
      const popup = new StashedPopup({
        name: __privateGet7(this, _name2),
        origin: __privateGet7(this, _origin2),
        network: __privateGet7(this, _network3)
      });
    ...
    __privateAdd5(this, _signTransaction, async ({ transaction, account }) => {
      const popup = new StashedPopup({
        name: __privateGet7(this, _name2),
        origin: __privateGet7(this, _origin2),
        network: __privateGet7(this, _network3)
    ...
    __privateSet6(this, _name2, name2);
    __privateSet6(this, _network3, network);
    if (address) {
  ...
  get features() {
    return {
      ...
      "sui:signTransaction": {
        version: "2.0.0",
        signTransaction: __privateGet7(this, _signTransaction)
      },
...
function registerStashedWallet(name2, {
  origin,
  network = "mainnet"
} = {}) {
...
// node_modules/.pnpm/zustand@4.5.6_@types+react@18.3.18_react@18.3.1/node_modules/zustand/esm/middleware.mjs
...
function WalletListItem({ name: name2, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime13.jsx)("li", { className: container7, children: (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        typeof icon === "string" ? (0, import_jsx_runtime13.jsx)("img", { className: walletIcon2, src: icon, alt: `${name2} logo` }) : icon,
        (0, import_jsx_runtime13.jsx)(Heading, { size: "md", truncate: true, asChild: true, children: (0, import_jsx_runtime13.jsx)("div", { children: name2 }) })
      ]
    }
  ) });
}
...
function registerUnsafeBurnerWallet(suiClient) {
  ...
  class UnsafeBurnerWallet {
    constructor() {
      ...
      __privateAdd6(this, _signTransaction2, async (transactionInput) => {
        var _a3;
      ...
      __privateAdd6(this, _signAndExecuteTransaction, async (transactionInput) => {
        var _a3;
        const { bytes, signature } = await Transaction.from(
          await transactionInput.transaction.toJSON()
        ).sign({
    ...
    get features() {
      return {
        ...
        "sui:signTransaction": {
          version: "2.0.0",
          signTransaction: __privateGet8(this, _signTransaction2)
        },
        "sui:signAndExecuteTransaction": {
          version: "2.0.0",
          signAndExecuteTransaction: __privateGet8(this, _signAndExecuteTransaction)
        }
      };
    }
  }
